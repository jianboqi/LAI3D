...
if __name__ == "__main__":
    ...
    # Estimator type: AlphaByRtIntensity, AlphaByColumnNumber
    parse.add_argument("-estimator", required=True, help="PAD estimator", type=str, default="AlphaByColumnNumber")
